"""F1 2023 UDP Telemetry support package

This package is based on the CodeMasters Forum post documenting the F1 2023 packet format:

    https://forums.codemasters.com/topic/38920-f1-2023-udp-specification/
...
HeaderFieldsToPacketType = {
    ...
    (2023, 14, 1) : PacketCarTelemetryData_V1,
...
if __name__ == "__main__":
    ...
    assert ctypes.sizeof(PacketCarTelemetryData_V1) == 1352
